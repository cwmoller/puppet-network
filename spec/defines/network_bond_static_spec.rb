...
describe 'network::bond::static', :type => 'define' do
  ...
  context 'incorrect value: ipaddress' do
    ...
    it 'should fail' do
      expect {should contain_file('ifcfg-bond1')}.to raise_error(Puppet::Error, /expects a match for Stdlib::IP::Address::V4::Nosubnet /)
    end
  end
  ...
  context 'incorrect value: ipv6address' do
    ...
    it 'should fail' do
      expect {should contain_file('ifcfg-bond1')}.to raise_error(Puppet::Error, /(expects a Stdlib::IP::Address::V6 |expects a match for Variant\[Stdlib::IP::Address::V6::Full .*, Stdlib::IP::Address::V6::Compressed)/)
    end
  end
